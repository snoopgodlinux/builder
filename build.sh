...
{
	apt -y install libarchive-dev libbz2-dev libc6-x32 libcurl4-openssl-dev libffi-dev libfmt-dev libfuse2 libgdbm-dev libglib2.0-dev \
	libglib2.0-dev-bin libgmp-dev libgspell-1-dev libgtkmm-3.0-dev libgtksourceviewmm-3.0-dev libhwloc-dev libncurses5-dev libnotify-bin \
	libnss3-dev libreadline-dev libsnoopgod libsodium-dev libspdlog-dev libsqlite3-dev libssl-dev libtool libuchardet-dev libuv1-dev \
	libxml++2.6-dev libxml2 libxml2-dev libxslt1-dev zlib1g-dev
}
